...
const FloatingChat = () => {
  ...
  return (
    <>
      {isOpen && (
        <div
          className="fixed bottom-24 right-6 z-50 w-80 h-96 rounded-lg border-2 flex flex-col dark:(bg-[var(--bg-card)] border-[var(--border-neon)] shadow-[0_0_15px_var(--border-neon)])"
          style={{
